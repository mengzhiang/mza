	...
	tree.on("click", function(node) {
		...
		tab = tabs.add({
			...
			html : "<iframe id = '"
					...
					+ "' src='/S2SH"
					+ node.attributes.url
					+ "' scrolling='yes' frameborder='0' width='100%' onload='document.getElementById("+node.attributes.id+").height =document.body.clientHeight-115;'></iframe>",
			closable : true
		});
